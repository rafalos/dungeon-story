export default {
  ...
  secondary: [
    ...
    { stat: 'coldDamage', range: { min: 5, max: 30 }, label: 'Adds {value}% cold damage' },
    { stat: 'lightingDamage', range: { min: 5, max: 30 }, label: 'Adds lighting damage' },
    { stat: 'bloodDamage', range: { min: 5, max: 30 }, label: 'Adds {value}% blood damage' },
  ],
};
